dic= [{'titulo': 'Qual o resultado da operação 57 + 32?',
          'nivel': 'facil',
         ...
         {'titulo': 'Quais as cores da bandeira do Brasil?',
          'nivel': 'facil',
          'opcoes': {'A': 'Verde, Vermelho, Amarelo e Azul', 'B': 'Amarelo, Azul, Verde e Roxo', 'C': 'Verde, Amarelo, Azul e Branco', 'D': 'Verde, Laranja, Vermelho e Azul' },
          'correta': 'C'},

         {'titulo': 'Quantos meses tem um semestre?',
          'nivel': 'facil',
          'opcoes': {'A': '4', 'B': '5', 'C': '12', 'D': '6' },
          'correta': 'D'},

         {'titulo': 'Qual é o resultado da operação 35-15 ?',
          'nivel': 'facil',
          'opcoes': {'A': '30', 'B': '20', 'C': '10', 'D': '25' },
          'correta': 'B'},
         ...
         {'titulo': 'Quais dessas palavras não é um palíndromo?',
          'nivel': 'medio',
          'opcoes': {'A': 'Osso', 'B': 'Arara', 'C': 'Raspar', 'D': 'Omissíssimo'},
          'correta': 'C'},

         {'titulo': 'O que é a Via Láctea?',
          'nivel': 'medio',
          'opcoes': {'A': 'Marca de Leite', 'B': 'Civilização Antiga', 'C': 'Carro', 'D': 'Galáxia'},
          'correta': 'D'},

         {'titulo': 'Em qual esporte existe a jogada "STRIKE"?',
          'nivel': 'medio',
          'opcoes': {'A': 'Futebol', 'B': 'Xadrez', 'C': 'Boliche', 'D': 'Tênis de Mesa'},
          'correta': 'C'},
         ...
         {'titulo': 'Quantos noves tem de 0 a 100?',
          'nivel': 'dificil',
          'opcoes': {'A': '10', 'B': '11', 'C': '20', 'D': '21'},
          'correta': 'C'},

         {'titulo': 'Quais dessas frases não é um palíndromo?',
          'nivel': 'dificil',
          'opcoes': {'A': 'A lupa pula', 'B': 'A mãe te ama', 'C': 'A missa é péssima', 'D': 'A dama admirou o rim da amada'},
          'correta': 'C'},
